...
<a class="btn btn-primary" href="generate_laporan_pembelian.php?Kirim=ok&tglm=<?=$tgl_mulai?>&tgls=<?=$tgl_selesai?>">UNDUH</a>



<!-- <form method="post" action="generate_laporan_pembelian.php">
	<div class="row">
		<div class="col-md-5">
			<div class="form-group">
				<label>Tanggal Mulai</label>
