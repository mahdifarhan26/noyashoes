...
<head>
	...
	<title>NoyaShoes | Best Seller</title>
...
<section class="kontent">
	<div class="container">
		<h1></h1><br>
		<h1>Produk Best Seller</h1><br>
		<div class="row">
		<?php $ambil = $koneksi->query("SELECT * FROM produk WHERE 
		jumlah_terjual=(SELECT MAX(jumlah_terjual)FROM produk) "); ?>
